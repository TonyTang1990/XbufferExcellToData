...
namespace Data
{
    ...
    public class t_AuthorInfo3Container
    {
        ...
        /// 只读数据列表
        /// </summary>
        private ReadOnlyCollection<t_AuthorInfo3> readOnlyList = null;
        ...
        /// 只读数据Map<ID, 数据>
        /// </summary>
        private ReadOnlyDictionary<int, t_AuthorInfo3> readOnlyMap = null;

        /// <summary>
        /// 获取数据列表
        /// </summary>
        public ReadOnlyCollection<t_AuthorInfo3> GetList()
        {
        ...
        /// 获取数据Map
        /// </summary>
        public ReadOnlyDictionary<int, t_AuthorInfo3> GetMap()
        {
            if (readOnlyMap == null)
            {
                LoadDataFromBin();
        ...
        public void LoadDataFromBin()
        {
            ...
            if(fs != null)
            {
                ...
                try{
                    ...
                    readOnlyList = new ReadOnlyCollection<t_AuthorInfo3>(list);
                    readOnlyMap = new ReadOnlyDictionary<int, t_AuthorInfo3>(map);
                }catch (Exception ex)
                {
