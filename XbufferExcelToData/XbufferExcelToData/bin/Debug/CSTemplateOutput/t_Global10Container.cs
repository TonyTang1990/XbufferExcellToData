...
namespace Data
{
    ...
    public class t_Global10Container
    {
        ...
        /// 只读数据列表
        /// </summary>
        private ReadOnlyCollection<t_Global10> readOnlyList = null;
        ...
        /// 只读数据Map<ID, 数据>
        /// </summary>
        private ReadOnlyDictionary<int, t_Global10> readOnlyMap = null;

        /// <summary>
        /// 获取数据列表
        /// </summary>
        public ReadOnlyCollection<t_Global10> GetList()
        {
        ...
        /// 获取数据Map
        /// </summary>
        public ReadOnlyDictionary<int, t_Global10> GetMap()
        {
            if (readOnlyMap == null)
            {
                LoadDataFromBin();
        ...
        public void LoadDataFromBin()
        {
            ...
            if(fs != null)
            {
                ...
                try{
                    ...
                    readOnlyList = new ReadOnlyCollection<t_Global10>(list);
                    readOnlyMap = new ReadOnlyDictionary<int, t_Global10>(map);
                    list.Clear();
                    map.Clear();
                }catch (Exception ex)
                {
