...
namespace Data
{
    ...
    public class t_AuthorInfo9Container
    {
        ...
        /// 只读数据列表
        /// </summary>
        private ReadOnlyCollection<t_AuthorInfo9> readOnlyList = null;
        ...
        /// 只读数据Map<ID, 数据>
        /// </summary>
        private ReadOnlyDictionary<int, t_AuthorInfo9> readOnlyMap = null;

        /// <summary>
        /// 获取数据列表
        /// </summary>
        public ReadOnlyCollection<t_AuthorInfo9> GetList()
        {
        ...
        /// 获取数据Map
        /// </summary>
        public ReadOnlyDictionary<int, t_AuthorInfo9> GetMap()
        {
            if (readOnlyMap == null)
            {
                LoadDataFromBin();
